    ...
    if (!menuExists) {
        ...
        currentSnippets.forEach(snippet => {
            ...
            menu.addItem(snippetElement => {
                ...
                toggleComponent.setValue(customCss.enabledSnippets.has(snippet)).onChange(value => {
                    customCss.setCssEnabledStatus(snippet, value);
                });
                toggleComponent.toggleEl.addEventListener("click", e => {
                    e.stopPropagation();
                });
                buttonComponent
                    .setIcon("ms-snippet")
...
class MySnippetsSettingTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(toggle => {
                toggle.setValue(this.plugin.settings.openSnippetFile).onChange(value =>
                    __awaiter(this, void 0, void 0, function* () {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(toggle => {
                toggle.setValue(this.plugin.settings.snippetEnabledStatus).onChange(value =>
                    __awaiter(this, void 0, void 0, function* () {
        ...
        stylingTemplateContent.setValue(this.plugin.settings.stylingTemplate).onChange(value =>
            __awaiter(this, void 0, void 0, function* () {
